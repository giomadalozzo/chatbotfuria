...
class HLTVAchievementsService:
    """Fake service that returns achievements data"""
    
    def get_furia_achievements(self) -> Dict:
        """Return FURIA achievements"""
        # Here we could use some e-Sports API
        # For now, mocked data
        return {
            "achievements": [
